...
from GraphData_Normalized import training_GraphData_N, testing_GraphData_N
from VAL_Script import rollout, get_inner_model
from DataSet import TA
...
class CriticBaseline(Baseline):
    ...
    def eval(self, x, graph, c):
        ...
        return v.detach(), F.mse_loss(v, c)
...
class RolloutBaseline(Baseline):
    ...
    def _update_model(self, model, epoch, dataset=None):
        ...
        num_samples = self.opts.rollout_size
        # self.dataset = training_GraphData_N(2, num_samples)
        self.dataset = TA.make_dataset(
    ...
    def wrap_dataset(self, dataset):
        ...
        # r = rollout(self.model, dataset, self.opts).view(-1, 1)
