...
def load_problem(name):
    from waypoint_follower_pkg.TRATSS_Model.problems import TSP, TSPSL
    problem = {
        'tsp': TSP,
        'tspsl': TSPSL
        # 'cvrp': CVRP,
...
def load_model(path, epoch=None, extra_logging=False):
    from waypoint_follower_pkg.TRATSS_Model.graph_decoder import AttentionModel
    from waypoint_follower_pkg.TRATSS_Model.graph_attention_encoder import GraphAttentionEncoder
    from waypoint_follower_pkg.TRATSS_Model.gnn_encoder import GNNEncoder
    from waypoint_follower_pkg.TRATSS_Model.critic_network import CriticNetwork
